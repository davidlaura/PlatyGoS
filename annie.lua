...
function Annie:__init()
	...
	self.Config = MenuConfig("za Lauru", "ZaLauru")
		self.Config:Menu("Combo", "Combo")
			self.Config.Combo:Boolean("Q", "koristi Q", true)
			self.Config.Combo:Boolean("W", "koristi W", true)
			self.Config.Combo:Boolean("E", "korisit E", true)
			self.Config.Combo:Boolean("R", "korsiti R", true)
		self.Config:Menu("Harass", "Harass")
			self.Config.Harass:Boolean("Q", "koristi Q", true)
			self.Config.Harass:Boolean("W", "koristi W", false)
			self.Config.Harass:Boolean("E", "koristi E", true)
			self.Config.Harass:Boolean("R", "koristi R", false)
		self.Config:Menu("LastHit", "ubijajMinione")
			...
			self.Config.LastHit:Boolean("stun", "Lasthit dok je stun up(ne diraj)", true)
		self.Config:Menu("LaneClear", "LaneClear")
			self.Config.LaneClear:Boolean("Q", "koristi Q", true)
			self.Config.LaneClear:Boolean("W", "koristi W", true)
			self.Config.LaneClear:Boolean("E", "korsiti E", false)
			self.Config.LaneClear:Boolean("R", "koristi R", false)
			self.Config.LaneClear:Boolean("stun", "LaneClear while StunUP", true)
		self.Config:Menu("Killsteal", "Killsteal")
			self.Config.Killsteal:Boolean("Q", "koristi Q", true)
			self.Config.Killsteal:Boolean("W", "koristi W", true)
			self.Config.Killsteal:Boolean("E", "korsiti E", true)
			self.Config.Killsteal:Boolean("R", "koristi R", true)
		self.Config:Menu("Misc", "Misc")
			self.Config.Misc:Boolean("autoQ","AutoLastHit sa Q", false)
			self.Config.Misc:Boolean("as", "AutoE za stun", false)
			self.Config.Misc:DropDown("autoult", "AutoUlt", 2, {"Always", "Stun Only"})
			self.Config.Misc:DropDown("numult", "koliko njih za auto ult(ne diraj)", 3, {"1", "2", "3", "4", "5"})
			self.Config.Misc:SubMenu("ft", "FlashTibbers")
				self.Config.Misc.ft:Boolean("stun", "korisit flash sa stunom", true)
				self.Config.Misc.ft:Slider("r", "Range za medu", 1000, 600, 1100, 1)
				self.Config.Misc.ft:Slider("n", "broj enemya", 3, 1, 5, 1)
		self.Config:Menu("Killsteal", "kradi killove (ne meni)")
			self.Config.Killsteal:Boolean("Q", "koristi Q", true)
			self.Config.Killsteal:Boolean("W", "koristi W", true)
			self.Config.Killsteal:Boolean("R", "koristi R", true)
		...
		self.Config:Menu("Draw", "Draws")
				self.Config.Draw:Boolean("DmgDraw", "prikazi dmg na njima koji ces napravit", true)
			for i = 0,3 do
		...
		self.Config:Menu("Keys", "tipke za sta su")
			...
			self.Config.Keys:KeyBinding("LastHit", "ubijajminione", string.byte("X"))
